...
public class GameManager : MonoBehaviour 
{
    ...
    public void AddNormarMonster(string monsterName , string iconPath,string prefabPath,ActoryType type, int maxHP, int currentHP,int damage, int rewardCoin, int rewardExp)
    {
